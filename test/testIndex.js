...
GeoPackage.setCanvasKitWasmLocateFile(file => path.join(__dirname, '..', 'node_modules', '@ngageoint', 'geopackage', 'dist', 'canvaskit', file));
...
describe('KML and KMZ to Geopackage Tests', function() {
    ...
    it ('should call progress call backs when defined', async function () {
        ...
        const options = {
            ...
            tableName: path.basename(waterKml, path.extname(waterKml)),
